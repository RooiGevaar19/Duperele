do
    n = input("Podaj wymiar n (4-15): ", "s");
until (isstrprop(n, "digit") && (str2num(n) >= 4) && (str2num(n) <= 15));
n = str2num(n);
...
do
    ...
    printf("  7 - Wykonaj mnożenie \n");
    printf("  0 - Wyjdź \n");
    command = input("Twój wybór: ","s");
until (isstrprop(command, "digit") && (any(0:7 == str2num(command))));
...
elseif (command == 6)
    ...
    A
elseif (command == 7)
    disp("Podaj liczby do pomnożenia")
    a = input("x: "); 
    b = input("y: ");
    A(a, b)
else
